        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel navbar-dark bg-dark">
            <div class="container  ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a href="{{ route('profile', ['id' => Auth::user()->id]) }}" class="dropdown-item">Mi perfil</a>    
                    ...
                    <form id="buscador" method="get" class="form-inline my-2 my-lg-0" action="{{ route('user.index') }}">
                        <input id="search" class="form-control mr-sm-2" type="text" placeholder="@...">
